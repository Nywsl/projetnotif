...
<nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
  ...
  <div class="collapse navbar-collapse justify-content-primary" id="navigation">
    <ul class="navbar-nav">
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="{{ route('preinscription') }}" class="nav-link">
               {{ __("Pre-inscription") }}
            </a>
          </li>
          <li class="nav-item">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navigation">
      <ul class="navbar-nav">
        ...
        <!--<li class="nav-item @if ($activePage == 'modalite') active @endif ">
            <a href="{{ route('panierafficher') }}" class="nav-link">
                <i class="now-ui-icons shopping_cart-simple"></i> {{ __("panier") }}
            </a>
          </li>-->
