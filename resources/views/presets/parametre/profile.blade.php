        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('parametres.profile.update') }}" autocomplete="off">
                            @csrf
                            @method('put')
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('parametres.profile.password') }}" autocomplete="off">
                            @csrf
                            @method('put')
            ...
            <div class="col-md-4">
                <div class="card card-user">
                    <div class="image">
                        <img src="{{ asset('assets/img/bg5.jpg') }}" alt="Background Image">
                    </div>
                    <div class="card-body">
                        <div class="author">
                            <a href="#">
