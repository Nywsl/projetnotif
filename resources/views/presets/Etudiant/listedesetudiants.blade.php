        ...
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-primary btn-round text-white pull-right" href="{{ route('pageajoutetudiants') }}">Ajouter un Étudiant</a>
                     <!-- Formulaire d'importation -->
                     <form action="{{ route('importeretudiants') }}" method="POST" enctype="multipart/form-data" class="pull-right">
                        @csrf
                    ...
                    <a href="" class="btn btn-primary btn-round text-white pull-right"><i class="now-ui-icons arrows-1_cloud-download-93"></i> Exporter</a>
